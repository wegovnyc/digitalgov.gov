jQuery(document).ready(function($) {
	function enable_edit_this(){
		$('*[data-edit-this]').each(function(){
			...
			var edit_link = '<a class="edit_this_btn" href="https://github.com/wegovnyc/digitalgov.gov/edit/'+branch+'/content/'+filepath+'" title="edit this" target="_blank"><span>edit</span></a>';
